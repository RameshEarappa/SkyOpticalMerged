table 37 "Sales Line"
{
        ...
        field(5705;"Cross-Reference No.";Code[20])
        {
            ...
            begin
                ...
                IF "Cross-Reference No." <> '' THEN BEGIN
                  ...
                  IF (ReturnedCrossRef."Unit of Measure" <> '') AND
                     ("Unit of Measure Code" <> ReturnedCrossRef."Unit of Measure")
                  THEN
    ...
    keys
    {
        ...
        key(Key9;"Recalculate Invoice Disc.")
        {
        }
    }
    ...
    var
        ...
        LineInvoiceDiscountAmountResetTok: Label 'Invoice discount amount has been reset in %1', Comment='%1 - caption of field "Inv. Discount Amount", %2 - Record ID';
    ...
    begin
        ...
        IF "No." = '' THEN
          EXIT(FALSE);
        GetItem;
        EXIT(NOT Item.IsNonInventoriableType);
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterCalcVATAmountLines(var SalesHeader: Record "36";var SalesLine: Record "37";var VATAmountLine: Record "290";QtyType: Option General,Invoicing,Shipping)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterUpdateVATOnLines(var SalesHeader: Record "36";var SalesLine: Record "37";var VATAmountLine: Record "290";QtyType: Option General,Invoicing,Shipping)
    begin
    end;
